...
public class CommonConfig {
   ...
   public static void setup() {
      ...
      ModLoadingContext.get().registerConfig(Type.COMMON, SPEC, "thirst/common.toml");
   }
   ...
   static {
      ...
      NETHER_THIRST_DEPLETION_MODIFIER = BUILDER.comment("How much is hydration depletion in nether faster than overworld").defineInRange("netherThirstDeletionModifier", (double)3.0F, (double)1.0F, (double)5.0F);
