...
public class SandFilterScene {
   public static void filtering(SceneBuilder scene, SceneBuildingUtil util) {
      ...
      scene.world().modifyBlockEntity(topTankPos, FluidTankBlockEntity.class, (be) -> be.getTankInventory().fill(content, FluidAction.EXECUTE));
      ...
      scene.idle(10);
      scene.world().modifyBlockEntity(topTankPos, FluidTankBlockEntity.class, (be) -> be.getTankInventory().drain(4000, FluidAction.EXECUTE));
      scene.world().modifyBlockEntity(bottomTankPos, FluidTankBlockEntity.class, (be) -> be.getTankInventory().fill(content, FluidAction.EXECUTE));
      scene.idle(50);
   }
}
