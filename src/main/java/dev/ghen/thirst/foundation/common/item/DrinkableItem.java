...
public class DrinkableItem extends Item {
   ...
   public @NotNull ItemStack m_5922_(@NotNull ItemStack item, @NotNull Level level, @NotNull LivingEntity entity) {
   ...
   public @NotNull UseAnim m_6164_(@NotNull ItemStack p_42997_) {
      return UseAnim.DRINK;
   }

   public @NotNull InteractionResultHolder<ItemStack> m_7203_(@NotNull Level p_42993_, @NotNull Player p_42994_, @NotNull InteractionHand p_42995_) {
